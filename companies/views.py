...
class CompanyCreateView(APIView):
    ...
    def get(self, request, format=None):
        ...
        return render(request, 'company/company_novo.html', {'form': serializer, 'representantes': representantes})
...
class CompanyUpdateView(APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        representantes = Representante.objects.all()
        return render(request, 'company/company_editar.html', {'form': serializer, 'representantes': representantes, 'company': company})
...
class RepresentanteListView(APIView):
    def get(self, request, format=None):
        representantes = Representante.objects.all()
        return render(request, 'representante/representante_list.html', {'object_list': representantes})
...
class RepresentanteCreateView(APIView):
    ...
    def get(self, request, format=None):
        ...
        return render(request, 'representante/representante_novo.html', {'form': serializer})
...
class RepresentanteUpdateView(APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        return render(request, 'representante/representante_editar.html', {'form': serializer, 'representante': representante})
